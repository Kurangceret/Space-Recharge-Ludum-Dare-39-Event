...
local box_width = 58.0
local box_height = 6.0

local texture_width = 107
local texture_height = 31

local projectile_damage = 4.0

local Entity = {
	initializeData = {
		SpriteComponent = {
			textureLocation = Constant.ProjectilesTextureDir .. "spaceship_laser.png",
        ...
        AnimationComponent = {
			animScriptDir = Constant.AnimationScriptDir .. "SpaceShipLaserAnimation.lua"
